...
/*
IRCProtocol::IRCProtocol(Msg& parameters)
{
	//TODO:create an IRC backend
	d_client=IRCClient();
}
...
void IRCProtocol::sendMsg(Msg& msg)
{
	//TODO:send message through the irc backend
}
void IRCProtocol::login()
{
	//TODO:connect to pre-defined server, channels, set my status
}
void IRCProtocol::gotMsg(QString from, QString fromUri, QString receiver, QString msg)
{
	//TODO:called when there is a message arrived from IRC backend, forward the message to the server
}

bool IRCProtocol::available()
{
	//TODO:return whether the client is able to send/receive message now
	return d_properties["status"]!="offline";
}

QList<Msg> IRCProtocol::onlineBuddies()
{
	//TODO:return the online contacts available on this IRC backend
}
QString& operator[](QString propertyName)
{
	return d_properties[propertyName];
}
