...
void
SwitchBoardSession::connectSB (QStringList receivers)
{
...
void
SwitchBoardSession::msgDistributor (QString cmd)
{
...
void
SwitchBoardSession::sendMessage (QString receiver, QString message)
{
...
void
SwitchBoardSession::trySend (QString user)
{
...
void
SwitchBoardSession::send (QString /*receiver */ , QString message)
{
  QString len;
...
QString
  SwitchBoardSession::getParticipants (int /* desiredLength */ , Msn * msn)
{
  QStringList pt;
...
void
SwitchBoardSession::addHistory (QString sender, QString fromNick,
