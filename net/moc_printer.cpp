...
**
** Created: Wed May 27 16:18:10 2009
...
static const char qt_meta_stringdata_printer[] = {
    "printer\0\0resp\0readyRead(QHttpResponseHeader)\0"
};
...
int printer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: readyRead((*reinterpret_cast< const QHttpResponseHeader(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
